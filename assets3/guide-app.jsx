  ...
  return (
    <aside className="g-rail">
      ...
      <div className="g-rail__bottom">
        ...
        <a href="mailto:support@onedashengine.com">
...
function IndexView({ searchQ, setSearchQ, go }) {
  ...
  return (
    <div className="g-content g-index">
      ...
      <p className="g-index__sub">Documentation for clinicians, admins, and pharmacy operators — covering rules, automations, care gaps, outcomes, and Dash AI.</p>
