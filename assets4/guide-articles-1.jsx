      ...
      },
      {
        ...
        body: (
          <Hint type="info" title="Profile search is your go-to lookup tool">
            <p>This is the only permanent widget — it lives in the top-right corner of your Dashboard. Type a name, DOB, phone number, ID number, or NPI to find any patient or provider in OneDash and jump straight to their page.</p>
          </Hint>
        ),
      },
    ],
