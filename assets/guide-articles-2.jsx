        ...
        body: (
          <>
            ...
            <DocImage
              ...
              caption="The Population Browser: filters on the left, a live patient table on the right. Save any view as a static tag or a fluid filter preset."
            />
          </>
        ),
      },
    ...
    sections: [
      {
        ...
        body: (
          <>
            ...
            <DocImage
              src={(window.UG_ASSET_BASE || "") + "care-gaps-1.png"}
              alt="Care Gaps Work Queue — each row is a member with their assigned care gaps, sort and search controls, and per-row Pick Up Member, info, and Mark as Complete actions."
              caption="Work Queue mode groups care gaps per member. Pick up a member to start working their gaps, or use the search and sort to focus your queue."
            />
