    ...
    sections: [
      {
        ...
        body: (
          <>
            <p><strong>OneDash is the solution that allows you to identify your care gaps, act on those gaps, and track your outcomes, all in one place</strong> — powered by Dash AI.</p>
            <DocImage
              src={(window.UG_ASSET_BASE || "") + "overview-1.png"}
              alt="OneDash architecture — Self Service, Automation & AI, Analytics & ML, and a unified bidirectional data layer connected to Pharmacy Claims, Medical Claims, SDOH, FHIR/HL7, Inpatient Usage, EHR, and Custom Documents."
              caption="OneDash sits on a unified bidirectional data layer, fed by claims, clinical, and SDOH sources — surfaced through self-service tooling, Dash AI, and ready-made analytics."
            />
          ...
          <>
            <Steps>
              ...
              <Step title="Password email">
                <p>Shortly after the welcome email, you'll get a second email to set your password. Follow the prompts. Once set, head to <code>app.onedashengine.com</code> to sign in.</p>
              </Step>
              <Step title="Log in">
        ...
        body: (
          <Steps>
            ...
            <Step title="Log back in">
              <p>Head back to <code>app.onedashengine.com</code> and do amazing things.</p>
            </Step>
          </Steps>
        ),
      },
          ...
          <>
            <div style={{ padding: 28, background: "var(--g-card-bg)", border: "1px solid var(--g-border)", borderRadius: 12, display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <div>
                ...
                <a href="mailto:support@onedashengine.com" style={{ fontSize: 22, fontWeight: 700, color: "var(--g-fg-1)" }}>support@onedashengine.com</a>
              </div>
            </div>
    ...
    sections: [
      {
        ...
        body: (
          <>
            ...
            <DocImage
              src={(window.UG_ASSET_BASE || "") + "my-dashboard-1.png"}
              alt="OneDash Dashboard showing Paused Care Gaps, Patients View, and Urgent Care Gaps widgets, plus the Profile Search field in the top right."
              caption="A Dashboard with three widgets and the always-on Profile Search in the top right."
            />
          </>
        ),
      },
        ...
        body: (
          <Steps>
            <Step title="Open the customizer">
              <p>Click <strong>Customize</strong> in the top-right of your dashboard, then click <strong>+ Add new</strong> to open the widget gallery.</p>
            </Step>
            ...
            <Step title="Save your layout">
              <p>When you're happy with the layout, click <strong>Close</strong> to save and exit the customizer.</p>
            </Step>
          </Steps>
        ),
      },
      {
        id: "profile-search",
        title: "Searching for patients and providers",
        body: (
          <>
            <p><strong>Search for Patients and Providers</strong> sits in the top-right corner of your Dashboard. It's the only permanent widget — it's always there, on every Dashboard layout — and it's the fastest way to jump straight to anyone in OneDash.</p>
            <DocImage
              src={(window.UG_ASSET_BASE || "") + "dashboard-search-1.png"}
              alt="The Search for Patients and Providers field in the top right of the Dashboard, with placeholder text reading Enter Member Number, NPI, Name, Phone, or DOB."
              caption="The search field lives in the top-right of your Dashboard and accepts several kinds of input."
            />
            <h3>What you can search by</h3>
            <ul>
              <li><strong>Member Number</strong> — a patient's ID number.</li>
              <li><strong>NPI</strong> — a provider's National Provider Identifier.</li>
              <li><strong>Name</strong> — first or last name, for either patients or providers.</li>
              <li><strong>Phone</strong> — a phone number on file.</li>
              <li><strong>DOB</strong> — a patient's date of birth.</li>
            </ul>
            <h3>Reading your results</h3>
            <p>Results appear as you type — no need to press Enter. Patients and providers are returned together in one list, so a single search covers both.</p>
            <DocImage
              src={(window.UG_ASSET_BASE || "") + "dashboard-search-2.png"}
              alt="Search results for the term chris, showing a mixed list of Patient and Provider results. Each row has a blue Patient or Provider label, the person's name, their ID or NPI in brackets, an amber tag showing which field matched, and a phone number underneath."
              caption="Typing a partial name returns both patients and providers. Each result shows its type, ID, the field that matched, and a phone number."
            />
            <p>Each result row tells you four things:</p>
            <ul>
              <li><strong>Type</strong> — a blue <strong>Patient</strong> or <strong>Provider</strong> label, so you always know which kind of profile you're about to open.</li>
              <li><strong>Name and number</strong> — the person's name followed by their Member Number (patients) or NPI (providers) in brackets.</li>
              <li><strong>Why it matched</strong> — an amber tag naming the field your text was found in, such as <strong>First Name</strong>.</li>
              <li><strong>Phone number</strong> — the number on file, shown beneath the name.</li>
            </ul>
            <p>Click any result to open that patient's or provider's profile page. Click the <code>×</code> at the right of the field to clear your search and start over.</p>
            <Hint type="info" title="Tip">
              <p>You don't need a full or exact value. Partial text works — searching <code>chris</code> returns Chris, Christine, Christina, and Christopher across both patients and providers.</p>
            </Hint>
          </>
        ),
      },
